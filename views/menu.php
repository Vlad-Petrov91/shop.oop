...
<!-- ============================================
   ...
   ============================================ -->
<?php if ($auth) : ?>
    <div class="header__menu_greeting">
        ...
        <div id="authModal" class="auth-modal" role="dialog" aria-label="Authentication" aria-hidden="true">
            ...
            <div class="auth-modal__container">
                ...
                <div class="auth-modal__tabs">
                    <button class="auth-tab active" data-tab="login"><a href="/user/logout">Out</a></button>
                </div>
            ...
            <div class="auth-modal__body">
                ...
                <form id="loginForm" class="auth-form active">
                    <div class="form-group">
                        ...
                        <div class="error-message" id="loginError">Please enter a valid login</div>
                    </div>
                    <div class="form-group">
...
<script>
    (function() {
        ...
        // Функция обновления ARIA атрибутов
            ...
            async handleLogin(e) {
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        this.showNotification(data.login + ', welcome back!', 'success');
                        setTimeout(() => window.location.reload(), 1500);
                    } else {
                        this.showNotification('Error', 'error');
                        this.showError(login, document.getElementById('loginError'), data.message || 'Invalid email or password');
                    }
                } catch (error) {
                    console.error('Login error:', error);
                    this.showError(login, document.getElementById('loginError'), 'Connection error. Please try again.');
                } finally {
